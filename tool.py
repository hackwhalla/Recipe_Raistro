...
def including_and_excluding_ingredients_categories_and_title(includeIngredients, excludeIngredients, includeCategories, excludeCategories, page, title):
